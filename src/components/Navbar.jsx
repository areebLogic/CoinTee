    ...
    <>
      <nav className={sticky ? "sticky-nav" : ""}>
        <div className="navbar">
          ...
          <span>
            <a href="https://github.com/areebLogic" rel="noreferrer" target="_blank">
              <i className="fa-brands fa-github"></i>
            </a>
            <a href="https://linkedin.com/in/areebLogic" rel="noreferrer" target="_blank">
